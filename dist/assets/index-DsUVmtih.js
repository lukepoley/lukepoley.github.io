...
@@@@@@@@@@@@%#%%##%@@@@@@@@%%@@@@@@@@@@@@@@@@@@@@@@@@@@#%@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@=+@@@@@@@@@@@@@@@@@@@@@@@@@@@*++++++++++===++++++***####*######
@@@@@@@@@%%%%@@@@@@@@%%@@@@@@@@@@@@@@@@@@@@%%%@@@@@@@@@%#@@@@@@@@@@@@@@@@@@@@@@@@@%@@@%==@@@@@@@@@@@@@@@@@@@@@@@@@@@@+*+++====+++*******##########*###
`;function hw(){const t=f=>ye.jsxs("div",{className:"response-list",children:[ye.jsx("div",{children:"Available commands:"}),ye.jsxs("div",{children:["- ",ye.jsx("span",{className:"cmd clickable",onClick:()=>f("projects"),children:"projects"}),": View my projects"]}),ye.jsxs("div",{children:["- ",ye.jsx("span",{className:"cmd clickable",onClick:()=>f("about"),children:"about"}),": About me"]}),ye.jsxs("div",{children:["- ",ye.jsx("span",{className:"cmd clickable",onClick:()=>f("contact"),children:"contact"}),": Contact info"]}),ye.jsxs("div",{children:["- ",ye.jsx("span",{className:"cmd clickable",onClick:()=>f("clear"),children:"clear"}),": Clear terminal"]})]}),[e,n]=$t.useState([]),[i,r]=$t.useState(""),s=$t.useRef(null),o=$t.useRef(null),a=()=>{var f;(f=s.current)==null||f.focus()};$t.useEffect(()=>{var f;(f=o.current)==null||f.scrollIntoView({behavior:"smooth"})},[e]);const l=f=>{const d=f.trim().toLowerCase();let h=null;switch(d){case"help":h=t(l);break;case"projects":h=ye.jsxs("div",{className:"response-list",children:[ye.jsx("div",{children:"My Projects:"}),ye.jsxs("div",{children:["1. ",ye.jsx("a",{href:"https://github.com/lukepoley/Internetworking-Projects",target:"_blank",rel:"noopener noreferrer",children:"Internetworking Projects"})," - A collection of computer networking projects exploring the Internet’s layered architecture, core protocols (TCP, UDP, IP, BGP, DNS), and real-world trade-offs through hands-on implementation and measurement."]}),ye.jsxs("div",{children:["2. ",ye.jsx("a",{href:"https://github.com/lukepoley/Sales-Tax-Automation",target:"_blank",rel:"noopener noreferrer",children:"Sales Tax Automation & Audit Preparation Tool"})," - A high-performance Python-based automation tool designed to streamline the extraction, filtering, and reporting of Joint Interest Billing (JIB) data for tax compliance"]}),ye.jsxs("div",{children:["3. Check out my ",ye.jsx("a",{href:"https://github.com/lukepoley/Website-Projects",target:"_blank",rel:"noopener noreferrer",children:"Github"})," for more projects"]})]});break;case"about":h=ye.jsxs("div",{children:[ye.jsx("div",{children:"Hey there, I'm Luke Poley."}),ye.jsx("div",{children:"I am currently a Junior studying Computer Science at Carleton College, who is originally from Los Angeles. "}),ye.jsx("div",{children:"Occasionally, I’ll read philosophy (for boredom), climb a 14er, play golf for the aura, come up with a cool new board game idea, or play sports to strength my agency."}),ye.jsx("p",{}),ye.jsx("div",{children:"Fun Facts!: "}),ye.jsx("div",{children:" I daily drive a partition of CachyOS on my Asus G14"}),ye.jsx("div",{children:" Two of my favorite books are Evidence and Agency by Berislav Marušić and Games: Agency As Art by C. Thi Nguyen"}),ye.jsx("div",{children:" The two food groups are snacks and meals "}),ye.jsx("p",{}),ye.jsx("div",{children:"Here is a ascii rendition of myself"}),ye.jsx("pre",{style:{fontSize:"6px",lineHeight:"6px"},children:dw})]});break;case"contact":h=ye.jsxs("div",{children:["Email: ",ye.jsx("a",{href:"mailto:poleydev@gmail.com",children:"poleydev@gmail.com"}),ye.jsx("br",{}),"GitHub: ",ye.jsx("a",{href:"https://github.com/lukepoley",children:"lukepoley"})]});break;case"clear":n([]);return;case"":break;default:h=`Command not found: ${d}`}n(h||d===""?m=>[...m,{type:"command",content:f},{type:"output",content:h}]:m=>[...m,{type:"command",content:f}])};$t.useEffect(()=>{n([{type:"output",content:"Welcome to lpoley terminal v1.0.0"},{type:"output",content:t(l)}])},[]);const u=f=>{f.key==="Enter"&&(l(i),r(""))};return ye.jsxs("div",{className:"app-container",onClick:a,children:[ye.jsx(fw,{}),ye.jsxs("div",{className:"terminal-interface",children:[ye.jsx("div",{className:"history",children:e.map((f,d)=>ye.jsxs("div",{className:`line ${f.type}`,children:[f.type==="command"&&ye.jsx("span",{className:"prompt",children:"lpoley@website:~$ "}),f.content]},d))}),ye.jsxs("div",{className:"input-line",children:[ye.jsx("span",{className:"prompt",children:"lpoley@website:~$"}),ye.jsx("input",{ref:s,type:"text",value:i,onChange:f=>r(f.target.value),onKeyDown:u,className:"terminal-input",autoFocus:!0})]}),ye.jsx("div",{ref:o})]}),ye.jsx(cw,{})]})}Iu.createRoot(document.getElementById("root")).render(ye.jsx(k_.StrictMode,{children:ye.jsx(hw,{})}));
